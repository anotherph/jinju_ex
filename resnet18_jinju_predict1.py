...
if __name__ == "__main__":       
    ...
    path_annos_tot="/home/jekim/workspace/jinju_ex/data/white1/annos_tot"
    ...
    for file_name_temp in list_:
        ...
        with torch.no_grad():
            ...
            best_network.cuda()
            best_network.load_state_dict(torch.load('/home/jekim/workspace/jinju_ex/log/20220616_093129_df2op/df2op_5.pth')) 
            best_network.eval()
            ...
            plt.text(10,20,"up-end: {:.0f}".format(landmarks_knife[0][2]),fontsize=20) # print visibility
            plt.text(10,35,"down-end: {:.0f}".format(landmarks_knife[1][2]),fontsize=20)
            # plt.text(10,10,str(landmarks_knife[0][2]),fontsize=20) # print visibility
            ...
            landmark_re=landmark_Recursion(landmarks_pose[ind_hand,:],display_result)
            plt.figure(figsize=(10,10))
            plt.imshow(image)
            ...
            # plt.text(100,100,str(landmarks_knife[0][2]),fontsize=20,color = 'y') # print visibility
            # a=1
