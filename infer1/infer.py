...
def infer_func(sample):
    ...
    center_position_left=infer_center(net_center, sample_center, num_class=1)
    ...
    landmarks_left=infer_landmarks(net_landmark, sample_landmark, num_class=2)
    ...
    center_position_right=infer_center(net_center, sample_center, num_class=1)
    ...
    landmarks_right=infer_landmarks(net_landmark, sample_landmark, num_class=2)
