...
if __name__ == "__main__":       
    ...
    path_image='/home/jekim/workspace/jinju_ex/data/blue/images'
    path_annos_tot="/home/jekim/workspace/jinju_ex/data/blue/annos_tot"
    ...
    for file_name_temp in list_:
        ...
        # landmarks_knife_left=np.array(annos['knife'])[3:6].reshape(-1,3) #left
        # landmarks_knife=np.array(annos['knife'])[9:].reshape(-1,3) # right
        # landmarks=landmarks_knife_left
        ...
        with torch.no_grad():
            ...
            best_network.cuda()
            best_network.load_state_dict(torch.load('/home/jekim/workspace/jinju_ex/log/20220613_204928_df2op/df2op_50.pth')) 
            best_network.eval()
        ...
        landmarks_pose=np.array(annos['pose_keypoints_2d']).reshape(-1,3)
        # landmarks_knife=np.array(annos['knife'])[3:6].reshape(-1,3) #left
        # landmarks_knife_right=np.array(annos['knife'])[9:].reshape(-1,3) # right
        # landmarks=landmarks_knife_right
        ...
        with torch.no_grad():
            ...
            best_network = Network()
            best_network.cuda()
            best_network.load_state_dict(torch.load('/home/jekim/workspace/jinju_ex/log/20220614_105854_df2op/df2op_50.pth')) 
            best_network.eval()
        ...
        landmark_re_left=landmark_Recursion(landmarks_pose[9,:],display_left)
        landmark_re_right=landmark_Recursion(landmarks_pose[10,:],display_right)
        ...
        # plt.text(100,100,str(landmarks_knife_left[0][2]),fontsize=20,color = 'y') # print visibility
        # plt.text(1700,100,str(landmarks_knife_right[0][2]),fontsize=20,color = 'b') # print visibility
        # a=1
        plt.savefig(os.path.join('/home/jekim/workspace/jinju_ex/data/blue/result1/',file_name+'_pre.png'))
